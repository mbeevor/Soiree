...
public class DinnerAdapter extends RecyclerView.Adapter<DinnerAdapter.DinnerAdapterViewHolder>{
    ...
    /** adapter for RecyclerView in uk.co.beevorwhite.soiree.MainActivity showing list of saved dinner parties
     */
    ...
    public class DinnerAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        /** corresponding ViewHolder to power DinnerAdapter RecyclerView in uk.co.beevorwhite.soiree.MainActivity showing list of saved dinner parties
         */
